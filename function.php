...
function sendMessageService($panel_info, $config, $sub_link, $username_service, $reply_markup, $caption, $invoice_id, $user_id, $image = 'images.jpg')
{
    global $setting, $textbotlang;

    // اگر $user_id ارسال نشده باشد، تابع را متوقف کن
    if (empty($user_id)) {
        error_log("sendMessageService: user_id is required!");
        return false;
    }
    ...
    // ========== 1. ارسال لینک اشتراک با کیوآرکد ==========
    $out_put_qrcode = "";
...
// تابع کمکی برای استخراج اسم کانفیگ از لینک
