...
elseif ($datain == "systemsms") {
...
} elseif (($text == $textbotlang['keyboard']['botReports'] || $text == $textbotlang['keyboard']['adminVideo']['reports']) && $adminrulecheck['rule'] == "administrator") {
...
} elseif ($text == $textbotlang['keyboard']['adminVideo']['userServices'] && $adminrulecheck['rule'] == "administrator") {
    $keyboardtypelistuser = json_encode([
        'inline_keyboard' => [
            ...
            [['text' => $textbotlang['keyboard']['agentList'], 'callback_data' => "agentlistusers"], ['text' => $textbotlang['keyboard']['allUserList'], 'callback_data' => "alllistusers"]],
            [['text' => $textbotlang['keyboard']['searchOrder'], 'callback_data' => "searchorder"], ['text' => $textbotlang['keyboard']['groupCharge'], 'callback_data' => "balanceaddall"]],
            [['text' => $textbotlang['keyboard']['searchUserBtn'], 'callback_data' => "searchuser"], ['text' => $textbotlang['keyboard']['messagingSection'], 'callback_data' => "systemsms"]],
            [['text' => $textbotlang['keyboard']['groupVolumeOrTime'], 'callback_data' => "voloume_or_day_all"]]
        ]
    ]);
    sendmessage($from_id, $textbotlang['Admin']['selectOption3'], $keyboardtypelistuser, 'html');
    ...
    step('home', $from_id);
} elseif (($text == $textbotlang['Admin']['btnKeyboard']['managementPanel'] || $text == $textbotlang['keyboard']['adminVideo']['panelManagement']) && $adminrulecheck['rule'] == "administrator") {
