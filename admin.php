...
if (in_array($text, $textadmin) || $datain == "admin") {
    ...
    step('home', $from_id);
} elseif ($text == $textbotlang['Admin']['Status']['btn'] || $datain == "stat_all_bot" || (($text == $textbotlang['keyboard']['adminVideo']['quickAccount'] || $text == $textbotlang['keyboard']['adminVideo']['botStatus']) && $adminrulecheck['rule'] == "administrator")) {
...
} elseif (($text == $textbotlang['Admin']['btnKeyboard']['managementPanel'] || $text == $textbotlang['keyboard']['adminVideo']['panelStatus'] || $text == $textbotlang['keyboard']['panelListStatus']) && $adminrulecheck['rule'] == "administrator") {
