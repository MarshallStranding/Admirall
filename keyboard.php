...
// Administrator menu follows the reference video while preserving every existing
// administrator capability inside the relevant submenus below.
if ($adminrulecheck['rule'] == "administrator") {
    $adminSettingsMenu = json_encode([
        'keyboard' => [
            [['text' => $textbotlang['keyboard']['shopSettings']], ['text' => $textbotlang['Admin']['btnKeyboard']['managementPanel']]],
            ...
            [['text' => $textbotlang['keyboard']['generalSettings']], ['text' => $textbotlang['keyboard']['financial']]],
            [['text' => $textbotlang['keyboard']['featureStatus']], ['text' => $textbotlang['keyboard']['supportSection']]],
            [['text' => $textbotlang['keyboard']['educationSection']], ['text' => $textbotlang['keyboard']['botReport']]],
            [['text' => $textbotlang['keyboard']['botReports']], ['text' => $textbotlang['keyboard']['panelFeatures']]],
            [['text' => $textbotlang['keyboard']['adminSection']], ['text' => $textbotlang['bottext']['open_button']]],
            [['text' => $textbotlang['keyboard']['agentMembershipFee']], ['text' => $textbotlang['keyboard']['reWebhookAgentBots']]],
            [['text' => $textbotlang['keyboard']['resellerManagement']]],
            [['text' => $textbotlang['keyboard']['setTestAccountLimitAll']], ['text' => $textbotlang['keyboard']['pendingReceipts']]],
            [['text' => $textbotlang['Admin']['backAdminBtn']]]
        ],
        'resize_keyboard' => true
    ]);

    // Payment management hub: keeps all existing payment handlers intact while
    // giving the administrator one clear entry point before the gateway-specific screens.
    $adminPaymentManagementMenu = json_encode([
        'keyboard' => [
            [['text' => $textbotlang['keyboard']['financial']], ['text' => $textbotlang['keyboard']['setCardNumber']]],
            [['text' => $textbotlang['keyboard']['supportId']], ['text' => $textbotlang['keyboard']['offlineGatewayPv']]],
            [['text' => $textbotlang['keyboard']['pendingReceipts']], ['text' => $textbotlang['keyboard']['autoConfirmNoCheck']]],
    ...
    // Wallet management hub: uses the existing balance/user/payment handlers.
    $adminWalletManagementMenu = json_encode([
        'keyboard' => [
            [['text' => $textbotlang['keyboard']['walletAdmin']['chargeUser']], ['text' => $textbotlang['keyboard']['walletAdmin']['decreaseUser']]],
            [['text' => $textbotlang['keyboard']['walletAdmin']['groupCharge']], ['text' => $textbotlang['keyboard']['walletAdmin']['usersWithBalance']]],
            [['text' => $textbotlang['keyboard']['walletAdmin']['usersWithNegativeBalance']], ['text' => $textbotlang['keyboard']['walletAdmin']['resetUser']]],
            [['text' => $textbotlang['keyboard']['walletAdmin']['backSettings']]],
        ],
        'resize_keyboard' => true
    ]);

    // Panel hub: keeps selection-dependent actions behind the existing panel selector.
    // This mirrors the reference-style admin hierarchy without bypassing current handlers.
    ...
    $keyboardadmin = json_encode([
        'keyboard' => [
            [['text' => $textbotlang['keyboard']['adminVideo']['reports']], ['text' => $textbotlang['keyboard']['adminVideo']['quickAccount']]],
            [['text' => $textbotlang['keyboard']['adminVideo']['viewUserInfo']], ['text' => $textbotlang['keyboard']['adminVideo']['userServices']]],
            [['text' => $textbotlang['keyboard']['adminVideo']['autoConfirm']], ['text' => $textbotlang['keyboard']['adminVideo']['pendingReceipts']]],
            [['text' => $textbotlang['keyboard']['adminVideo']['panelStatus']], ['text' => $textbotlang['keyboard']['adminVideo']['botStatus']]],
            [['text' => $textbotlang['keyboard']['adminVideo']['otherSettings']]],
            [['text' => $textbotlang['keyboard']['adminVideo']['panelManagement']]],
            [['text' => $textbotlang['keyboard']['adminVideo']['backMain']]]
        ],
        'resize_keyboard' => true
    ]);
}
...
if ($adminrulecheck['rule'] == "support") {
    $keyboardadmin = json_encode([
        'keyboard' => [
            [['text' => $textbotlang['keyboard']['supportDesk']], ['text' => $textbotlang['keyboard']['manageUser']]],
            [['text' => $textbotlang['keyboard']['supportSearchUser']], ['text' => $textbotlang['keyboard']['supportMyTickets']]],
            [['text' => $textbotlang['users']['backbtn']]]
        ],
        'resize_keyboard' => true
    ]);
}
$adminSupportDeskMenu = json_encode([
    'inline_keyboard' => [
        [['text' => $textbotlang['keyboard']['supportMyTickets'], 'callback_data' => 'support_tickets'], ['text' => $textbotlang['keyboard']['supportRefresh'], 'callback_data' => 'support_tickets']],
        [['text' => $textbotlang['keyboard']['supportSearchUser'], 'callback_data' => 'support_search_user']],
...
// Shop menu is arranged like the reference video: core management stays visible,
// while legacy/advanced shop controls are grouped under "misc settings" instead
// of being removed.
$shopkeyboard = json_encode([
    'keyboard' => [
        [['text' => $textbotlang['keyboard']['manageProducts']], ['text' => $textbotlang['keyboard']['manageCategory']]],
        [['text' => $textbotlang['keyboard']['discountMenu']]],
        [['text' => $textbotlang['keyboard']['shopVideo']['misc']]],
        [['text' => $textbotlang['keyboard']['shopVideo']['testAccount']]],
        [['text' => $textbotlang['keyboard']['shopVideo']['renewSettings']], ['text' => $textbotlang['keyboard']['shopVideo']['refundRequest']]],
        [['text' => $textbotlang['keyboard']['shopVideo']['thanksMessage']], ['text' => $textbotlang['keyboard']['purchaseCommission']]],
        [['text' => $textbotlang['keyboard']['minBulkBalance']], ['text' => $textbotlang['keyboard']['minCustomVolume']]],
        [['text' => $textbotlang['keyboard']['shopVideo']['productTariff']], ['text' => $textbotlang['keyboard']['shopVideo']['subscriptionButton']]],
        [['text' => $textbotlang['keyboard']['shopVideo']['productTariff']], ['text' => $textbotlang['keyboard']['shopVideo']['specialSaleDiscount']]],
        [['text' => $textbotlang['keyboard']['firstPurchaseCommission']], ['text' => $textbotlang['keyboard']['qrBackground']]],
        [['text' => $textbotlang['keyboard']['shopVideo']['autoAccount']]],
        [['text' => $textbotlang['Admin']['backAdminBtn']], ['text' => $textbotlang['Admin']['backMenuBtn']]]
    ],
    'resize_keyboard' => true
]);

$shopDiscountKeyboard = json_encode([
    'keyboard' => [
        ...
        [['text' => $textbotlang['Admin']['backAdminBtn']], ['text' => $textbotlang['keyboard']['backToShopMenu']]],
    ],
    'resize_keyboard' => true
]);

$shopMiscKeyboard = json_encode([
    'keyboard' => [
        [['text' => $textbotlang['keyboard']['shopFeatureStatus']]],
        [['text' => $textbotlang['keyboard']['renewalCashback']], ['text' => $textbotlang['keyboard']['renewalStatus']]],
        [['text' => $textbotlang['keyboard']['purchaseCommission']], ['text' => $textbotlang['keyboard']['refundBtn']]],
        [['text' => $textbotlang['keyboard']['firstPurchaseCommission']], ['text' => $textbotlang['keyboard']['quickSetTimePrice']]],
        [['text' => $textbotlang['keyboard']['quickSetVolumePrice']], ['text' => $textbotlang['keyboard']['maxCustomVolume']]],
        [['text' => $textbotlang['keyboard']['minCustomTime']], ['text' => $textbotlang['keyboard']['maxCustomTime']]],
        [['text' => $textbotlang['keyboard']['setTestAccountLimitAll']], ['text' => $textbotlang['keyboard']['qrBackground']]],
...
function KeyboardProduct($location, $query, $pricediscount, $datakeyboard, $statuscustom = false, $backuser = "backuser", $valuetow = null, $customvolume = "customsellvolume")
{
    ...
    // سطر اول: عنوان "مبلغ" (سبز) و "محصول" (آبی) - جابجا شد
    $product['inline_keyboard'][] = [
        ['text' => '💲 مبلغ', 'callback_data' => 'price_title', 'style' => 'success'],
        ['text' => '🛍️ محصول', 'callback_data' => 'product_title', 'style' => 'primary']
    ];
    ...
    while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        $product_price = number_format($result['price_product']) . ' تومان';

        // ستون چپ: قیمت (سبز)، ستون راست: اسم محصول (آبی)
        $product['inline_keyboard'][] = [
            ['text' => $product_price, 'callback_data' => "price_{$result['code_product']}{$valuetow}", 'style' => 'success'],
            ['text' => $product_name, 'callback_data' => "{$datakeyboard}{$result['code_product']}{$valuetow}", 'style' => 'primary']
        ];
    }

    // دکمه حجم دلخواه (چپ: قیمت، راست: اسم) - جابجا شد
    if ($statuscustom) {
        $custom_volume_price = select("shopSetting", "*", "Namevalue", "customvolmef", "select")['value'];
        if (empty($custom_volume_price)) {
            $custom_volume_price = "4000";
        }
        $product['inline_keyboard'][] = [
            ['text' => number_format($custom_volume_price) . ' تومان', 'callback_data' => 'custom_volume_price', 'style' => 'success'],
            ['text' => '📥 حجم دلخواه', 'callback_data' => $customvolume, 'style' => 'primary']
        ];
    }
...
function KeyboardCategory($location, $agent, $backuser = "backuser")
{
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        // تعیین رنگ بر اساس موقعیت (پنل)
        $style = 'primary'; // پیش‌فرض آبی
        if (strpos($location, 'Multi') !== false || strpos($location, 'مولتی') !== false) {
            $style = 'primary'; // آبی
        } elseif (strpos($location, 'Economy') !== false || strpos($location, 'اکونومی') !== false) {
            $style = 'purple'; // بنفش
        } elseif (strpos($location, 'نامحدود') !== false) {
            $style = 'success'; // سبز
        }
        ...
        $list_category['inline_keyboard'][] = [
            [
                'text' => $row['remark'],
                'callback_data' => "categorynames_" . $row['id'],
                'style' => $style
            ]
        ];
    }
...
function keyboard_config($config_split, $id_invoice, $back_active = true)
{
    ...
    // Configs are now delivered directly, one-by-one, with no config keyboard.
    $keyboard = ['inline_keyboard' => []];
    if ($back_active) {
        global $textbotlang;
        $keyboard['inline_keyboard'][] = [[
            'text' => $textbotlang['users']['status']['backinfo'],
            'callback_data' => 'product_' . $id_invoice
        ]];
    }
